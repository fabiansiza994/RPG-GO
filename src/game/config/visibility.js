/* ============================================================
   ...
   - MEDIUM:    visibilidad media (Torres normales — la segunda de cada zona, no "landmark" —,
                Santuarios, Fogatas, Mercader Ambulante, NPCs dinámicos) — se dibujan solo dentro
                de MEDIUM_DISTANCE_M. Antes TODAS las torres eran siempre visibles; para no saturar
                el mapa con demasiados íconos permanentes, ahora solo la mitad (la "landmark" de
                cada zona) lo es — la otra mitad aparece por proximidad, igual que un santuario.
