...
/** Variantes de dificultad para las Zonas Peligrosas (ver main.js, rollDangerZoneChallenge) — a
 *  diferencia de DIFFICULTY_TIERS de arriba (70% "normal", MÁS DÉBIL que el jugador), acá nunca
 *  sale nada por debajo del CP del propio jugador: el punto de una zona peligrosa es que sea un
 *  reto real, no una tirada que a veces toca fácil. */
export const DANGER_ZONE_DIFFICULTY_TIERS = [
  { key: "strong",    label: "Fuerte",     weight: 35, cpMin: 0.95, cpMax: 1.15 },
  { key: "elite",     label: "Élite",      weight: 40, cpMin: 1.25, cpMax: 1.55 },
  { key: "legendary", label: "Legendario", weight: 25, cpMin: 1.65, cpMax: null, cpMaxFallbackMult: 2.10 },
];
